...
export class DatabaseV11776451915698 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "destinations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "country" character varying NOT NULL, "city" character varying NOT NULL, "iata_code" character varying(10), "airport_name" character varying(255), CONSTRAINT "PK_69c5e8db964dcb83d3a0640f3c7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "vouchers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "id_request" uuid NOT NULL, "class" character varying NOT NULL, "amount" numeric NOT NULL, "tax_type" character varying NOT NULL, "currency" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "file_url_pdf" character varying, "file_url_xml" character varying, "status" character varying NOT NULL, "id_approver" uuid, "fiscal_uuid" character varying(36), "issuer_rfc" character varying, "issuer_name" character varying, "receiver_rfc" character varying, "subtotal" numeric(12,2), "tax_amount" numeric(12,2), "retention_amount" numeric(12,2), CONSTRAINT "UQ_554686d12219653a9f1a8f5eed9" UNIQUE ("fiscal_uuid"), CONSTRAINT "PK_ed1b7dd909a696560763acdbc04" PRIMARY KEY ("id"))`);
