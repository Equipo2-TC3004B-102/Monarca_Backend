...
export class UpdateAdvanceMoneyDecimal1779348072482 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "requests" DROP CONSTRAINT "FK_c806f2fb7ccae0a3b98dabc6a4a"`);
        ...
        await queryRunner.query(`ALTER TABLE "requests" ADD CONSTRAINT "FK_c806f2fb7ccae0a3b98dabc6a4a" FOREIGN KEY ("id_ceco") REFERENCES "cost_centers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
